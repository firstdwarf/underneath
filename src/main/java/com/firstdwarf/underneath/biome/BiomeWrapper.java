...
import com.firstdwarf.underneath.world.VolcanoBiome;
...
public class BiomeWrapper {
    ...
    public static final RegistryObject<Biome> volcano = BIOMES.register("volcano", //This sets registry name
            ()-> new VolcanoBiome(new Biome.Builder()
                    ...
                    .surfaceBuilder(SurfaceBuilder.DEFAULT,
                            new SurfaceBuilderConfig(
                                    Blocks.SNOW.getDefaultState(), //Surface block info
                                    Blocks.DIRT.getDefaultState(), //just under the surface block info
                                    Blocks.STONE.getDefaultState())) //under the water block info
                    .category(Biome.Category.EXTREME_HILLS)
                    .downfall(0.5f) //how often it rains (ex. .5 would fall half the time)
                    .depth(0.12f) //how low is your biome
                    .parent("minecraft:snowy_mountains")
            ));

    public static void registerBiomes() {
        registerBiome(testBiome.get(), Type.PLAINS, Type.OVERWORLD); //This determines how the biome spawns

        registerBiome(volcano.get(), Type.OVERWORLD, Type.DEAD, Type.WASTELAND, Type.MOUNTAIN, Type.COLD, Type.SNOWY);
